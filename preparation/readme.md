...
* Download the file [`pyproject.toml`](https://raw.githubusercontent.com/ScaDS/eosc-ssds-2026/main/preparation/pyproject.toml) (right-click > "Save Link As"), save as `pyproject.toml` in this folder
